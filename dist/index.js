...
const U = __ENV.BASE_URL, N = 30 * 60, g = __ENV.ROOT_URL, l = function(o) {
  let e;
  ...
  const e = c.get(`${g}/auth/login`, {
    headers: l(o)
  });
  return c.cookieJar().clear(g), e;
}, re = function(o) {
  const e = c.cookieJar();
  return e.set(g, "oneSessionId", o.token), e.set(g, "XSRF-TOKEN", o.getCookie("XSRF-TOKEN") || ""), o;
}, se = function(o, e, t, r) {
  let s = {
    grant_type: "password",
    username: o,
...
}, d = __ENV.ROOT_URL, J = new v(d).hostname, b = __ENV.DEFAULT_PASSWORD || "password";
function y(o, e) {
...
function pe(o, e, t) {
  ...
  if (r)
    ...
    a.status !== 201 && (console.error(a.body), k(`Could not create structure ${o}`)), r = y(o, t);
  }
  return r;
}
function ue(o) {
...
function P(o, e, t) {
  ...
  if (r)
    ...
    c.post(
      ...
      s.body(),
      p
    ).status != 200 && k(`Could not create structure ${o}`), r = y(o, t);
  }
  return r;
}
function de(o, e, t) {
...
function V(o, e, t) {
  ...
  return c.post(`${d}/directory/positions`, s, { headers: r });
}
function ke(o, e, t) {
  const r = V(o, e, t);
...
function ye(o, e) {
  ...
  if (r)
    ...
    s = c.post(`${$}/appregistry/role`, JSON.stringify(f), {
      headers: i
    }), console.log(s), u(s, { "save role ok": (p) => p.status == 201 }), r = R(t, e);
  }
  return r;
}
function A(o, e) {
...
function _e(o, e, t) {
  ...
  if (r)
    ...
    }), a = c.put(`${w}/directory/group/${i}`, n, { headers: s }), u(a, {
...
export {
  ...
  C as Session,
  h as SessionMode,
  $e as WS_MANAGER_SHARE,
  we as WS_READER_SHARE,
  L as activateUser,
  F as activateUsers,
  ...
  ce as checkStatus,
  ye as createAndSetRole,
  _e as createBroadcastGroup,
  j as createDefaultStructure,
  pe as createEmptyStructure,
  V as createPosition,
  ke as createPositionOrFail,
